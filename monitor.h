...
extern char fsOsCommand(unsigned char *linhacomando, unsigned int ix, unsigned int iy, unsigned char *linhaarg, unsigned char *vparam, unsigned char *vparam2, unsigned char *vparam3, unsigned char* vresp);
#endif
