...
unsigned long *floatNumA0           = 0x008FEF8E; // com o valor a colocar em A0 para saber qual BNE usar
unsigned long *randSeed             = 0x008FEF86; // Numero para ser usado no randomico
unsigned char *lastHgrX             = 0x008FEF84; //
unsigned char *lastHgrY             = 0x008FEF82; //
unsigned char *vDataPointer         = 0x008FEF80; // 
unsigned char *vDataLineAtu         = 0x008FEF78; // 
unsigned long *vDataBkpPointerProg  = 0x008FEF70; // 
unsigned char *vDataFirst           = 0x008FEF6E; // 
unsigned char *token                = 0x008FEE6E; // 
unsigned char *aswerPointer         = 0x008FED6E; //

const keywords_count = 63;
