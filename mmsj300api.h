...
unsigned char *color_table_size = 0x00611804;
...
unsigned char *kbdScanCodeBuf   = 0x00609B50;
unsigned char *kbdScanCodeCount = 0x00609B62;
unsigned char *kbdClockCount   = 0x00609B64;  // Countador do clock para recebimento de tecla PS/2
unsigned short *scanCode       = 0x00609B66;
