; D:\PROJETOS\MMSJ300\PROGS_MONITOR\TESTE_HGR.C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J.Fondse
; #include <ctype.h>
; #include <string.h>
; #include <stdlib.h>
...
_uvdp_plot_hires:
       ...
       move.b    15(A6),D7
       and.l     #255,D7
; unsigned int offset = 8 * (x / 8) + y % 8 + 256 * (y / 8);
       move.b    D5,D0
       and.l     #65535,D0
       divu.w    #8,D0
       and.w     #255,D0
...
; writeLongSerial("Aqui 777.666.0-[");
       pea       @teste_hgruvdp_plot_hires_1.L
       jsr       (A2)
       addq.w    #4,A7
; itoa(x,sqtdtam,16);
       pea       16
...
; writeLongSerial(sqtdtam);
       ...
       addq.w    #4,A7
; writeLongSerial(",");
       pea       @teste_hgruvdp_plot_hires_2.L
       jsr       (A2)
       addq.w    #4,A7
; itoa(y,sqtdtam,16);
       pea       16
...
; writeLongSerial(sqtdtam);
       ...
       addq.w    #4,A7
; writeLongSerial("]-[");
       pea       @teste_hgruvdp_plot_hires_3.L
       jsr       (A2)
       addq.w    #4,A7
...
; writeLongSerial(sqtdtam);
       ...
       addq.w    #4,A7
; writeLongSerial("]\r\n");
       pea       @teste_hgruvdp_plot_hires_4.L
       jsr       (A2)
       addq.w    #4,A7
...
; writeLongSerial("Aqui 777.666.1-[");
       pea       @teste_hgruvdp_plot_hires_5.L
       jsr       (A2)
       addq.w    #4,A7
...
; writeLongSerial("Aqui 777.666.2-[");
       pea       @teste_hgruvdp_plot_hires_6.L
       jsr       (A2)
       addq.w    #4,A7
; itoa(pixel,sqtdtam,16);
       pea       16
...
; }
       section   const
@teste_hgr@teste_hgr@teste_hgr@teste_1:
       dc.b      65,113,117,105,32,55,55,55,46,54,54,54,46,48
       dc.b      45,91,0
@teste_hgr@teste_hgr@teste_hgr@teste_2:
       dc.b      44,0
@teste_hgr@teste_hgr@teste_hgr@teste_3:
       dc.b      93,45,91,0
@teste_hgr@teste_hgr@teste_hgr@teste_4:
       dc.b      93,13,10,0
@teste_hgr@teste_hgr@teste_hgr@teste_5:
       dc.b      65,113,117,105,32,55,55,55,46,54,54,54,46,49
       dc.b      45,91,0
@teste_hgr@teste_hgr@teste_hgr@teste_6:
